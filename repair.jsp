   ...
   <table id="a" border=0 width=100% height=80%> 
      <tbody>
        <tr bgcolor="white">
          ...
          <td><a href="repair.jsp" style="font-weight:bold;">维修情况</a></td>
   ...
   <div id="mainin">
    ...
    <div id="in">
        <form action="repair_Servlet" method=post>     
                     ...
                     <br>维修结果：<input type=text name="result" size=9>
                     <br>维修花费：<input type=text name="pay" size=9>
                     <br>经手人员：<input type=text name="person" size=9>                    
                     <br>日期：<input type=text name="year" size=2>年<input type=text name="month" size=2>月
